...
Этот процесс значительно упрощается с помощью простого скрипта, который соберет ваш сайт и закоммитит папку `_site/` в ваш gh-pages. У многих людей есть такой. [Вот один](https://www.jokecamp.com/blog/Simple-jekyll-deployment-with-a-shell-script-and-github/). [Вот другой](https://gist.github.com/cobyism/4730490). Вот [мой скрипт публикации](https://github.com/untra/polyglot/blob/main/publi.sh):
```bash
#! /bin/sh
