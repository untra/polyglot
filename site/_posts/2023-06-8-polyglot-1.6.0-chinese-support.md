...
The [Polyglot website](https://polyglot.untra.io/) has been updated with support for Chinese!
...
With a big 谢谢 of support and appreciation to **aturret**, [polyglot.untra.io](https://polyglot.untra.io/) now supports a `zh-CN` Simplified Chinese translation!
