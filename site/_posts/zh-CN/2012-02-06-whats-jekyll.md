...
[Jekyll](https://jekyllrb.com) 是一款静态网站生成器，同时还是一款开源工具，可用于创建适用于各种形式及尺寸的简单却强大的网站。根据[Jekyll 的官方项目说明](https://github.com/mojombo/jekyll/blob/master/README.markdown):
